          ...
          <div class="flex items-center gap-3">
            ...
            <div class="hidden sm:block">
              ...
              <h2 class="text-base font-semibold leading-none">
                Laporan Jumlah Komponen Diolah
              </h2>
            </div>
          </div>
      ...
      <Table>
        <TableHeader class="bg-gray-100">
          <TableRow>
            ...
            <TableHead class="font-semibold text-gray-800">Jumlah</TableHead>
          </TableRow>
        </TableHeader>
...
const handleSearch = async () => {
  try {
    ...
    // wajib kirim start_date & end_date
    ...
    if (selectedKomponen.value && selectedKomponen.value !== 'all') {
      params.kode_komponen = selectedKomponen.value
    }

    // endpoint baru
    const { data } = await api.get('/api/reports/stok_darah/komponen_diolah', { params })
  ...
  try {
    ...
    const response = await api.get(
      '/api/reports/stok_darah/komponen_diolah/export_excel',
    ...
    link.download = `Laporan_Jumlah_Komponen_Diolah_${new Date().toISOString().split('T')[0]}.xlsx`
